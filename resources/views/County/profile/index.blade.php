...
<div class="gen-sec">
   <div class="container type-2">
      ...
      <div class="user-info-box">
         ...
         <form method="post" enctype="multipart/form-data" action="{{route('county_change_image')}}">
            @csrf
            ...
            <div class="avatar-preview">
               <div id="imagePreview" style="background-image: url({{auth('admin')->user()->image ? auth('admin')->user()->image : asset('public/avatar.png') }});">
               </div>
            </div>
...
<div class="modal payment-popup fade" id="newNumber-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
   <form method="post" action="{{route('county_updateprofile')}}">
      @csrf
         ...
         <div class="modal-content">
            <div class="modal-body">
               ...
               <div class="credit-card-info">
                  ...
                  <input type="text" name="phone" maxlength="20" placeholder="Phone Number" value="{{ auth('admin')->user()->phone }}" class="card-input" required>
         ...
         <div class="modal-content">
            <div class="modal-body">
               ...
               <div class="credit-card-info">
                  ...
                  <input type="text" name="user_name" maxlength="20" placeholder="User Name" value="{{ auth('admin')->user()->name }}" class="card-input">
                  <button type="submit" class="card-btn">Submit</button>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-body">
        ...
        <div class="credit-card-info">
          <form method="POST" action="{{ route('county_change_password') }}">
            @csrf
