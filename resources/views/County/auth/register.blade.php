...
<section class="genWrap">
   <div class="loginBox">
      <div class="textBox">
         ...
         <form class="registrationForm" method="POST" action="{{route('register-county')}}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group type-2 mb-3">
               <input type="email" placeholder="Email Address" readonly name="email" value="{{$email}}" required>
            </div>
