...
<body>
    <div id="loading" class="d-flex justify-content-center align-items-center">
        <img src="{{ asset('public/admin/assets/images/splash-logo.png') }}" alt=""
            class="zoom-in-zoom-out pulse">
    </div>
    <header>
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                @include('Teacher.slicing.county-module-nav.header')
        ...
        <div class="offcanvas offcanvas-start p-0" tabindex="-1" id="sideNavs" aria-labelledby="sideNavsLabel">
            @include('Teacher.slicing.county-module-nav.side-bar')
        </div>
        </aside>
        </div>
    ...
    <div class="modal payment-popup fade" id="newUsername-modal" tabindex="-1" role="dialog"
    ...
    <div class="modal payment-popup fade" id="newNumber-modal" tabindex="-1" role="dialog"
        aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <div class="credit-card-info">
                        <form>
                            <input type="tel" name="" maxlength="15" placeholder="New Phone Number"
                                class="card-input">
                            <button type="submit" class="card-btn">Submit</button>
                        </form>
                    </div>
    ...
    <!-- Change Phone Number Modal Start -->
    <div class="modal payment-popup fade" id="newEmail-modal" tabindex="-1" role="dialog"
        aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <div class="credit-card-info">
                        <form>
                            <input type="tel" name="" maxlength="15" placeholder="Update Email"
                                class="card-input">
                            <button type="submit" class="card-btn">Submit</button>
                        </form>
                    </div>
    ...
    <div class="modal payment-popup fade" id="newPassword-modal" tabindex="-1" role="dialog"
        aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <div class="credit-card-info">
                        <form>
                            <input type="password" name="" maxlength="30" placeholder="New Password"
                                class="card-input">
                            <input type="password" name="" maxlength="15" placeholder="Confirm Password"
                                class="card-input">
                            <button type="submit" class="card-btn">Submit</button>
                        </form>
                    </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <div class="credit-card-info">
                        <form>
                            <input type="email" name="" maxlength="30" placeholder="New Email Address"
                                class="card-input">
                            <input type="email" name="" maxlength="30" placeholder="Confirm Email Address"
                                class="card-input">
                            <input type="password" name="" maxlength="30" placeholder="Current Password"
                                class="card-input">
                            <button type="submit" class="card-btn">Submit</button>
                        </form>
                    </div>
    ...
    <div class="modal fade genModal" id="assignModal" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
    ...
    @include('County.slicing.footer-scripts')
