...
<div class="gen-sec">
   <div class="container type-2">
      ...
      <div class="user-info-box">
         ...
         <form method="post" enctype="multipart/form-data" action="{{ route('school_change_image')}}">
            @csrf
            ...
            <div class="avatar-preview">
               <div id="imagePreview" style="background-image: url({{auth('school')->user()->image ? auth('school')->user()->image : asset('public/avatar.png') }});">
               </div>
            </div>
...
<div class="modal payment-popup fade" id="newNumber-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
   <form method="post" action="{{route('school-admin-updateprofile')}}">
      @csrf
         ...
         <div class="modal-content">
            <div class="modal-body">
               ...
               <div class="credit-card-info">
                  ...
                  <input type="text" name="phone" maxlength="20" placeholder="Phone Number" value="{{ auth('school')->user()->phone }}" class="card-input" required>
         ...
         <div class="modal-content">
            <div class="modal-body">
               ...
               <div class="credit-card-info">
                  ...
                  <input type="text" name="user_name" maxlength="20" placeholder="User Name" value="{{ auth('school')->user()->name }}" class="card-input">
                  <button type="submit" class="card-btn">Submit</button>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-body">
        ...
        <div class="credit-card-info">
          <form method="POST" action="{{ route('school_admin_change_password') }}">
            @csrf
